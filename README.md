...
- **[Orbi](https://github.com/orbi-build/orbi)** – Fair-code autonomous delivery runner: label a GitHub Issue `ai-ready` and it implements, has an independent session review the frozen diff, merges only the reviewed commit, and ships a tagged release — unattended.
